...
const { CardsPage } = Templates;

class CardsPageView extends Component {
    constructor(props) {
      super(props);
        ...
        return(
          <section className="bg-show  ">
             <ThemeContext.Consumer>
                { context => {
                return <CardsPage {...pageProps} contextParames={context.parames} reRender={context.reRender} {...self.props} ref={(r)=>{ self.$$ListPageView = r }}   />
                }
              }
              </ThemeContext.Consumer>
          </section>
