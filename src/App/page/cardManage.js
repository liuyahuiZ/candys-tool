...
class ProjectManage extends Component {
    constructor(props) {
      ...
      this.state = {
        ...
        modalTplList: [{text: '请选择', value: ''},
        {text: '图文卡片模板', value: 'TextPicPage'},
        {text: '音频视频卡片模板', value: 'VideoPage'},
        {text: '链接模板', value: 'CardsPage'}],
            ...
            <Row className="padding-top-1r padding-left-1r padding-right-1r">
                ...
                <AnTransition delay={1} act={listBarStatus =='SHOW'? 'leave': 'enter'} duration={166} enter={'listTem-enter'} leave={'listTem-leave'} >
                    <Row className="padding-all-1r bg-show border-radius-3f ">
                        <Col className="line-height-3r border-bottom border-color-f5f5f5 text-overflow cursor-pointer" onClick={()=>{self.toggelListBar()}}><Icon iconName={'android-apps '} size={'130%'} /> CardList 页面列表</Col>
