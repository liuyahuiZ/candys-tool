...
class ProgressLoader extends Component {
  ...
  render() {
    const { barColor, radius, boxShad, loaderStyle } = this.props;
    ...
    const loaders = status === 'show' ? (<div style={arrayUtils.merge([styles.loader, loaderStyle])} className={classNames}>
