...
class Carousel extends Component {
  ...
  move() {
    ...
    if(!(arr[dotNum]&&arr[dotNum].tabName)) return;
    setInterval(() => {
  ...
  render() {
    ...
    return (
      <div className="carousel-container" ref={(r) => { this.$$container = r; }} style={arrayUtils.merge([styles.container, containerStyle])}>
        ...
        <div className="trans-slow" style={arrayUtils.merge([styles.tabContent, styles.floatLeft, itmWidth, height])}>
          <div className="trans-slow" ref={(r) => { this.$$tabContent = r; }} style={arrayUtils.merge([styles.tabContent, tabContentStyle, styles.floatLeft, contentWidth, height])} >
            { tabContent}
          </div>
        </div>
