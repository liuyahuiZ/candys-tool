...
import DatePicker from './DatePickerPc';
...
import Box from './CommonCheckbox/box';
...
import FileUpWithData from './FileUpWithData';
...
import RandomNum from './RandomNumber/randNum';
import Picker from './Picker';
import Step from './Step';
import TagRadio from './TagRadio';
// import DragCont from './DragCont';
import SortItem from './DragCont/sortItem';
import Scroller from './Scroller';
import FullScreen from './FullScreen';
import LoadText from './LoadText';
import LoadPage from './LoadText/loadPage';
